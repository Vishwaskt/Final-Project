...
<body>
    ...
    <li><a href="addvenue.jsp">Add Venue</a></li> 
        <li><a href="dviewven.jsp">View Venue</a></li> 
         <li><a href="dviewbook.jsp">View Bookings</a></li>
     <li><a href="viewrequest.jsp"class="current">View Request</a></li> 
...
String username = session.getAttribute("username").toString();
    try {
    PreparedStatement ps = connection.prepareStatement("select * from bookings where uploadedby='"+username+"' and status='waiting'");
    ResultSet rs1 = ps.executeQuery();

    %>
    <p><center><font size="5" color="skyblue">View Booking Requests & Accept  </font></center></p><br/>
    ...
    <td><a href="activate.jsp?username=<%=rs1.getString("username")%>&vname=<%=rs1.getString("vname")%>&date=<%=rs1.getString("date")%>&email=<%=rs1.getString("email")%>&phone=<%=rs1.getString("phone")%>&uploadby=<%=rs1.getString("uploadedby")%>">Activate</a></td>
