...
if(request.getParameter("msg")!=null){%>
    ...
    <script>alert('Images added Success..!')</script>
}  
...
%>
   ...
   <center><font size="6" color="white">Yamaha Motor - Bike E-Catalogue</font></center>
    ...
    <li><a href="addbike.jsp">Add Bike</a></li> 
     <li><a href="addimages.jsp" class="current">Add Images</a></li> 
    ...
    <center>
    <p><font size="4" color="red">Add Images</font></p><br/>   
    ...
    <tr>
    <td height="43"><font size="2"> Color </td>
    <td><font size="2"><input type="text" id="pic" name="color" required=""/></td>
    </tr>
